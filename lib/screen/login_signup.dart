...
import 'package:rajab/config/palette.dart';
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("images/bgl.jpg"), fit: BoxFit.fill)),
              child: Container(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? " Rajab," : " Back,",
                              style: TextStyle(
                                fontSize: 25,
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(MaterialCommunityIcons.account_circle_outline,
              "Full Name", false, false),
          buildTextField(
              MaterialCommunityIcons.map_outline, "Address", false, false),
